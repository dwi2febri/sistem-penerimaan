    ...
    <section id="intro" class="intro-section">
        <div class="container">
        	<div class="page-header">
			    <h1>PMB UNISBANK Tahun Akademik 2022/2023</h1>
			</div>
            ...
            <div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<img class="img-responsive" src="<?=base_url('assets') ?>/images/slide.jpg" alt="">
								<div class="carousel-caption">
									<h4>Wisuda Mahasiswa Unisbank</h4>
								</div>
							</div>
							<div class="item">
							...
							<div class="item">
								...
								<img class="img-responsive" src="<?=base_url('assets') ?>/images/slide.jpg" alt="">
								<div class="carousel-caption">
									<h4>Kegiatan Mahasiswa Unisbank
									</h4>
								</div>
							</div>
						</div>
                ...
                <div class="col-md-4">
                	<h3>Universitas Stikubank - UNISBANK Semarang</h3>
            ...
            <div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
                <div class="col-lg-12">
					...
					<div class="col-lg-6">
						...
						<img src="<?php echo base_url('assets/images/tip.png') ?>" alt="Laboratorium Komputer" class="img-thumbnail img-responsive">
					</div>
                </div>
            </div>
        </div>
    ...
    <section id="contact" class="contact-section">
        <div class="container">
            <div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
				...
				<p align="left"><i class="fa fa-envelope-o"></i><abbr title="Email">E</abbr>: unisbank@yahoo.com</p>
				<p align="left"><i class="fa fa-clock-o"></i><abbr title="Jam Kantor">J</abbr>: Senin - Sabtu: 8:00 sampai 15:00</p>
